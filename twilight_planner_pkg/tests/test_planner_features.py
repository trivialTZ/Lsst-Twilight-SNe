...
def test_exposure_capping_reduces_total():
    ...
    used_cap, timing_cap = choose_filters_with_cap(["r"], 0.0, 1000.0, cfg, use_capped_exposure=True)
    used_base, timing_base = choose_filters_with_cap(["r"], 0.0, 1000.0, cfg, use_capped_exposure=False)
